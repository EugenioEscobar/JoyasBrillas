...
function App() {
  return (
    <div className="overflow-hidden scroll-smooth font-josefin">
      ...
      >
        <div className="ml-[6rem] flex max-w-[700px] flex-col gap-y-4 pt-44">
          <div className="inline-block">
            <span className="inline-block bg-gradient-to-r from-yellow-200 to-secondary bg-clip-text font-ebGaramond text-xl font-bold capitalize italic text-transparent">
              Diseños Exclusivos
            </span>
          </div>
      ...
      <div className=" mt-20">
        ...
        <div className="flex w-full justify-center bg-primary text-white ">
          <div className="mt-14 block text-center font-ebGaramond">
            <h3 className="px-6 text-7xl italic">
              Nuestra colección destacada
            </h3>
            <hr className="my-2 border-secondary shadow shadow-secondary " />
        ...
        {/* Grilla de Productos */}
        <div className="flex w-full flex-wrap rounded-ee-3xl bg-primary px-16 pt-14 text-center text-white md:px-64">
            ...
            <a href="#product">
              ...
              <div className="flex justify-between">
                <div className="flex flex-col p-1 text-start text-sm">
                  ...
                  <span className="text-gray-300">Collar negro</span>
                </div>
      ...
      <div
        className="h-[93vh] bg-cover"
        style={{ backgroundImage: `url(${BannerPromo})` }}
      >
        {/* Separador Inferior */}
        <svg
          width="99%"
